...
[Route("api/projects/{projectId:guid}/3d-folders")]
[ApiController]
[Authorize]
public class ThreeDFolderController : APIBaseController
{
    private readonly IThreeDFolderService _service;

    public ThreeDFolderController(IThreeDFolderService service)
    {
        _service = service;
    }
    ...
    public async Task<IActionResult> CreateFolder(
        Guid projectId,
        [FromForm] CreateThreeDFolderDto dto,
    ...
    public async Task<IActionResult> UpdateFolder(
        Guid projectId,
        Guid folderId,
        [FromForm] UpdateThreeDFolderDto dto,
        CancellationToken cancellationToken)
    {
