...
public class ThreeDImageConfiguration : IEntityTypeConfiguration<ThreeDImage>
{
    public void Configure(EntityTypeBuilder<ThreeDImage> builder)
    {
        builder.ToTable("ThreeDImages", "client");
