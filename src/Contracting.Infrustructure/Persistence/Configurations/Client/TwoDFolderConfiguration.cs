...
public class TwoDFolderConfiguration : IEntityTypeConfiguration<TwoDFolder>
{
    public void Configure(EntityTypeBuilder<TwoDFolder> builder)
    {
        builder.ToTable("TwoDFolders", "client");
