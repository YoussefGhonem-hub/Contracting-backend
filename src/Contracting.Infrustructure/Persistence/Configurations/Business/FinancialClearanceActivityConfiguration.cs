...
{
    public class FinancialClearanceActivityConfiguration : IEntityTypeConfiguration<FinancialClearanceActivity>
    {
        public void Configure(EntityTypeBuilder<FinancialClearanceActivity> builder)
        {
            builder.ToTable("FinancialClearanceActivities", "business");
